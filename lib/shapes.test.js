...
describe("Triangle", () => {
  ...
  // Does the same thing as above for fillcolor
...
// Same test structure as above, for Circle constructor
describe("Circle", () => {
...
// Same test structure as above, for Square constructor
describe("Square", () => {
  test("should render svg for a green polygon element", () => {
    const expectedSvg =
